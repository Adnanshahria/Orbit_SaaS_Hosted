...
export default function AdminWhyUs() {
    const { lang, setLang, saving, saved, error, getData, save } = useSectionEditor('whyUs');
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between flex-wrap gap-3">
                <SectionHeader title="Why Us Section" description="Manage your unique selling points" />
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
                <h3 className="font-semibold text-foreground mb-4">USP Items</h3>
                <ItemListEditor
                    items={items}
                    setItems={setItems}
                    newItem={{ title: '', desc: '' }}
